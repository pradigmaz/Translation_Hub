...
from utils.file_monitoring import orphaned_cleanup, file_metrics
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--file-types',
            nargs='+',
            choices=['user', 'team', 'project', 'chapter', 'image', 'temporary'],
            default=['user', 'team', 'project', 'chapter', 'image', 'temporary'],
