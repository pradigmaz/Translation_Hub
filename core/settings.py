...
INSTALLED_APPS = [
    ...
    "background_task",
    "users.apps.UsersConfig",  # Перемещаем users в начало для корректной регистрации админки
...
MIDDLEWARE = [
    ...
    "users.middleware.AuthenticationAuditMiddleware",  # Аудит аутентификации
    "teams.middleware.TeamPermissionMiddleware",  # Обработка ошибок разрешений команд
    "django.contrib.messages.middleware.MessageMiddleware",
    "core.admin_middleware.AdminMessagesFilterMiddleware",  # Фильтрация уведомлений в админке
...
# Максимальный размер загружаемых файлов (50MB для файлов проектов)
...
SECURE_SSL_REDIRECT = False  # Принудительный HTTPS в продакшене
SECURE_HSTS_SECONDS = 0  # HTTP Strict Transport Security (1 год)
